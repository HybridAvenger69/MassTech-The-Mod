...
public class TileEntityFusionFurnace extends TileEntity implements IInventory, ITickable, ISidedInventory {
    ...
    {
        return this.hasCustomName() ? this.customName : "container.fusion_furnace";
    }
    ...
    public void update()
    {
        ...
        if(!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockFusionFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    {
        return ConfigHandler.FUSION_FURNACE_SPEED;
    }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack result = FusionFurnaceRecipes.getInstance().getFusionFurnaceResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));
    ...
    public void smeltItem()
    {
        if(this.canSmelt())
        {
            ...
            ItemStack result = FusionFurnaceRecipes.getInstance().getFusionFurnaceResult(input1, input2);
            ItemStack output = (ItemStack) this.inventory.get(3);
    ...
    {
        return "mttm:fusion_furnace_gui";
    }
