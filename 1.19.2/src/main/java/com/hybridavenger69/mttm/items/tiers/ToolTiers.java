    ...
    static {
        TECH = TierSortingRegistry.registerTier(
                new ForgeTier(2, 450, 3f, 4f, 7,
                        Tags.Blocks.NEEDS_NETHERITE_TOOL, () -> Ingredient.of(ItemRegistry.TECH_INGOT.get())),
    ...
    static {
        EUCLASE = TierSortingRegistry.registerTier(
                new ForgeTier(3, 900, 5f, 9f, 11,
                        Tags.Blocks.NEEDS_NETHERITE_TOOL, () -> Ingredient.of(ItemRegistry.EUCLASE_GEM.get())),
    ...
    static {
        ICARUS = TierSortingRegistry.registerTier(
                new ForgeTier(4, 1800, 7f, 12f, 15,
                        Tags.Blocks.NEEDS_NETHERITE_TOOL, () -> Ingredient.of(ItemRegistry.NETHER_INGOT.get())),
    ...
    static {
        ICARUS2 = TierSortingRegistry.registerTier(
                new ForgeTier(4, 25000, 8f, 18f, 32,
                        Tags.Blocks.NEEDS_NETHERITE_TOOL, () -> Ingredient.of(OtherRegistry.DOUBLE_NETHERITE_INGOT.get())),
