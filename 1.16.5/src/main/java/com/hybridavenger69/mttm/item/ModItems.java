...
public class ModItems
{
    ...
    public static final RegistryObject<Item> TECH_INGOT = ITEMS.register("tech_ingot",
            () -> new Item(new Item.Properties().group(ModItemGroup.MTTM_GROUP)));
    ...
    public static final RegistryObject<Item> TECH_SWORD= ITEMS.register("tech_sword",
            () -> new SwordItem(ModItemTier.TECH, 0, 2f, new Item.Properties().group(ModItemGroup.MTTM_GROUP)));

    public static final RegistryObject<Item> TECH_PICK= ITEMS.register("tech_pick",
            () -> new PickaxeItem(ModItemTier.TECH, 0, 2f, new Item.Properties().group(ModItemGroup.MTTM_GROUP)));

    public static final RegistryObject<Item> TECH_AXE= ITEMS.register("tech_axe",
            () -> new AxeItem(ModItemTier.TECH, 0, 2f, new Item.Properties().group(ModItemGroup.MTTM_GROUP)));

    public static final RegistryObject<Item> TECH_SHOVEL= ITEMS.register("tech_shovel",
            () -> new ShovelItem(ModItemTier.TECH, 0, 2f, new Item.Properties().group(ModItemGroup.MTTM_GROUP)));
    ...
    public static final RegistryObject<Item> EUCLASE_SWORD= ITEMS.register("euclase_sword",
            () -> new SwordItem(ModItemTier.EUCLASE, 0, 4f, new Item.Properties().group(ModItemGroup.MTTM_GROUP)));

    public static final RegistryObject<Item> EUCLASE_PICK= ITEMS.register("euclase_pick",
            () -> new PickaxeItem(ModItemTier.EUCLASE, 0, 4f, new Item.Properties().group(ModItemGroup.MTTM_GROUP)));

    public static final RegistryObject<Item> EUCLASE_AXE= ITEMS.register("euclase_axe",
            () -> new AxeItem(ModItemTier.EUCLASE, 0, 4f, new Item.Properties().group(ModItemGroup.MTTM_GROUP)));

    public static final RegistryObject<Item> EUCLASE_SHOVEL= ITEMS.register("euclase_shovel",
            () -> new ShovelItem(ModItemTier.EUCLASE, 0, 4f, new Item.Properties().group(ModItemGroup.MTTM_GROUP)));
