...
public class BlockFusionFurnace extends BlockBase implements ITileEntityProvider {
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos) {
        ...
        if(active) worldIn.setBlockState(pos, ModBlocks.FUSION_FURNACE.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(RUNNING, true), 3);
        else worldIn.setBlockState(pos, ModBlocks.FUSION_FURNACE.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(RUNNING, false), 3);
    ...
    private TileEntityFusionFurnace getTile(World worldIn, BlockPos pos) {
        return (TileEntityFusionFurnace) worldIn.getTileEntity(pos);
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        TileEntityFusionFurnace tileEntityFusionFurnace = (TileEntityFusionFurnace) worldIn.getTileEntity(pos);
        InventoryHelper.dropInventoryItems(worldIn, pos, tileEntityFusionFurnace);
